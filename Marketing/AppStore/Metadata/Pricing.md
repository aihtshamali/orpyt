...
- Status: Approved
- Duration: 1 month
- United States price: `$1.99/month`
...
- Status: Approved
- Duration: 1 year
- United States upfront price: `$14.99/year`
- Introductory offer: free for the first week
- Availability: all 175 countries or regions
...
- Pro Yearly: `$14.99/year`
- 7-day free trial on both
- Yearly shown as the recommended option in-app

Do not enable `Monthly with 12-Month Commitment` on the yearly product while the standalone monthly product exists. It adds another “monthly” concept, creates regional support differences, and can make pricing feel more complicated than it needs to be.
